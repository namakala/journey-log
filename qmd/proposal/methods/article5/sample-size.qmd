...
Having two sample size estimations, i.e. 119 and 156, the higher number of minimum sample is preferred. Initially, a pilot study according to @Cohen2013 will be commenced to acquire 156 individuals from the general population. Then, the required sample size is recalculated with Monte-Carlo simulation using the pilot data [@Green2016].
